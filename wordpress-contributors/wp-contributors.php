	...
	public function render_meta_box_content( $post ) {
		...
		echo "<ul>";
			...
			foreach ( $blogusers as $bloguser ) {
				...
				echo "<li>";
					echo "<label>";
						echo "<input type='checkbox' name='post_contributors_list[]' value='".esc_attr( $bloguser_id )."' ".$selected."/>";
...
function load_post_contributors_styles() {
    wp_enqueue_style( 'post-contributors', plugins_url( '__inc/css/wp-post-contributors.css', __FILE__ ) );
}
